    ...
    public static class McpTools
    {
        public static JsonArray All()
        {
            return new JsonArray
            {
                ...
                Tool("trace_ui_navigation_calls", "Trace button handlers through a bounded local and cross-type call graph. Returns source/view-reference candidates as evidence only and never creates executable transitions or routes; external AI must decide and submit a patch.", ("mapPath", "string"), ("query", "string"), ("offset", "number"), ("limit", "number"), ("knownViewNames", StringArray())),
                Tool("get_ui_nav_candidate_coverage", "Return only navigation candidates that do not yet have a candidateDecisions entry. Review and merge every page before finalizing generation.", ("mapPath", "string"), ("query", "string"), ("offset", "number"), ("limit", "number"), ("knownViewNames", StringArray())),
                Tool("finalize_ui_nav_map_generation", "Fail unless every current navigation candidate has a recorded transition, unresolved, or ignored decision. On success stamps candidate coverage and current map versions.", ("mapPath", "string"), ("limit", "number"), ("knownViewNames", StringArray())),
