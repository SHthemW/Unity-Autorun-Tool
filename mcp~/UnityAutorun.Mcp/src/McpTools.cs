    ...
    public static class McpTools
    {
        public static JsonArray All()
        {
            return new JsonArray
            {
                ...
                Tool("scan_ui_nav_sources", "Scan Unity Assets for UIForm ids, prefabs, classes, OpenUIForm calls, scene/procedure flows, and map coverage gaps. Use before generating large nav maps.", ("mapPath", "string"), ("kind", "string"), ("query", "string"), ("offset", "number"), ("limit", "number"), ("includeText", "boolean")),
