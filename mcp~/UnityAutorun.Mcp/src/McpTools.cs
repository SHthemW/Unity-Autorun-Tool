    ...
    public static class McpTools
    {
        public static JsonArray All()
        {
            return new JsonArray
            {
                ...
                Tool("save_ui_nav_map", "Create the canonical Unity-Autorun-Tool/Gen/ui-nav-map.json file when it does not exist. Full replacement of an existing map is refused; read it and use incremental patch tools instead.", ("map", "object"), ("mapJson", "string")),
