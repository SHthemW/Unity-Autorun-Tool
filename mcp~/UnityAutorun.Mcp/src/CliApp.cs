    ...
    public static class CliApp
    {
        ...
        private static void PrintUsage()
        {
            Console.WriteLine("Unity AutoRun MCP\n\n"
                ...
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- scan-nav-sources [--map <path>] [--known-view ViewName]\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- trace-nav-calls [--map <path>] [--query ViewName] [--known-view ViewName]\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- backfill-nav-map [--map <path>] [--preview true|false]\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- nav-map-summary [--map <path>]\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- nav-candidate-coverage [--map <path>] [--query ViewName] [--known-view ViewName]\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- finalize-nav-map [--map <path>] [--known-view ViewName]\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- routes [--map <path>]\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- route [--map <path>] --from A --to C\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- run-route [--map <path>] --from A --to C\n"
                + "  dotnet run --project mcp~/UnityAutorun.Mcp -- navigate-ui [--map <path>] --to TargetView [--from StartView]\n"
