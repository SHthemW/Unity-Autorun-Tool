...
1. Clone the project into the Unity project You can place it anywhere in the 'Asset' directory, and Unity will automatically search for the 'Editor' folder in this project
